...
public class Event_top_options extends SherlockActivity implements Callback,ActionBar.OnNavigationListener,OnItemSelectedListener  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.event_top_options);
	...
	public void methodToCallback(String display12) {
       ...
       Spinner my_spin=(Spinner)findViewById(R.id.event_property_spinner);
